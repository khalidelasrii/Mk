...
class CarouselPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Carrousel d\'images'),
        ),
        body: Container(
          ...
          child: CarouselSlider(
            options: CarouselOptions(
              ...
              autoPlayInterval: const Duration(
                  seconds: 3), // Intervalle de lecture automatique
              autoPlayAnimationDuration: const Duration(
                  milliseconds:
                      800), // Durée de l'animation de lecture automatique
              autoPlayCurve: Curves
                  .fastOutSlowIn, // Courbe d'animation de lecture automatique
              viewportFraction:
                  1, // Fraction de l'écran occupée par le carrousel
            ),
